...
const Home=()=>{
    return(
        <section id="home" className="min-h-[90vh]   bg-white lg:max-h-80 pt-24 m-8 flex flex-col lg:flex-row py-8 text-gray-800 font-bold lg:h-56 lg:p-8 dark:text-white">
    <div className="text-center w-full lg:w-1/2 flex flex-col mx-6 lg:px-8 p-2 lg:mt-36 h-screen ">
      ...
      <div className=' text-gray-600  py-4 flex justify-between font-display hover:justify-around flex-wrap my-4 text-wrap'>
        <span className='p-3 mb-8  border-2 rounded-full'>Livraison Express et Standard</span>
        <span className='p-4 mb-8  border-2 rounded-full'>Suivi en Temps Réel </span>
        <span className='p-4 mb-8  border-2 rounded-full'>Service Client 24/7</span>
        <span className='p-4 mb-8  border-2 rounded-full'>Options Flexibles</span>
      </div>
      <div className=' relative'>
        <LocationInput/>

        <div className=" absolute top-40 bottom-12 left-10 w-20 opacity-70 h-20 mix-blend-multiply filter blur-xl bg-blue-500 rounded-full animation-delay-4000">
      </div>
      </div>
